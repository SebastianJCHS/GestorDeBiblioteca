...
public class GestordeBiblioteca2 {
    ...
    public static void main(String[] args) {
        ...
        persona.cargarAdminsDesdeArchivo("Administrador.txt");
        persona.cargarClientesDesdeArchivo("Clientes.txt");
        carnets.cargarCarnetsDesdeArchivo("Clientes.txt");
        multas.cargarMultasDesdeArchivo("Multas.txt");
        libros.cargarLibrosDesdeArchivo("Libros.txt");
